...
public class Etudiant {
    ...
    public  void payeFrais (int frais){
        fraisPaye += frais;
        Ecole.updateTotalFraisReceve(fraisPaye);
    }
    ...
    /**
     *
     * @return le frais restants.
     */

    public int fraisRestants(){
        return fraisTotal - fraisPaye;
    }

    public String toString(){
        return "Nom d'étudiant : " + nom +
                " frais totaux payés jusqu'à présent chf" + fraisPaye;
    }
